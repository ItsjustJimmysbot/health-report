# Health Agent V6.0.0 - OpenClaw 专业健康分析 Skill
...
### 3. 配置文件 (config.json)
首次使用前，请编辑 `config.json` 配置你的数据路径（V6.0.0 配置结构）：
...
## ✨ V6.0.0 核心特性（含 5.8.x 兼容修复）

> 版本说明：当前发布主版本为 **V6.0.0**。文中保留的 "V5.8.1" 标识表示该能力在 5.8.1 首次引入并在 5.9.x 继续兼容。

*   **健康评分系统 V6.0.0**：全新五大核心评分指标

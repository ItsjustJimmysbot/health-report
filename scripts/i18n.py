...
TRANSLATIONS = {
    'zh': {
        ...
        'diet_record': '今日饮食记录',
        'diet_placeholder': '（未记录 - 可通过 Discord 私发补充，格式：饮食 早餐:xxx 午餐:xxx）',
        'notes': '身体状态备注',
        'notes_placeholder': '（未记录 - 可通过 Discord 私发补充，如：精力、情绪、皮肤状态、压力水平等）',
        'breakfast': '早餐',
        'lunch': '午餐',
        'dinner': '晚餐',
        'first_meal': '第一餐',
        ...
        'hour': '小时',
        'min': '分钟',
        'steps_vs_last': '步数 vs 上周',
        'sleep_vs_last': '睡眠 vs 上周',
        'hrv_vs_last': 'HRV vs 上周',
        'rhr_vs_last': '静息心率 vs 上周',
    },
    'en': {
        ...
        'diet_placeholder': '(Not recorded - Send via Discord to add, format: Diet Breakfast:xxx Lunch:xxx)',
        'notes': 'Personal Notes',
        'notes_placeholder': '(Not recorded - Send via Discord to add, e.g.: energy, mood, skin condition, stress level)',
        'breakfast': 'Breakfast',
        'lunch': 'Lunch',
        'dinner': 'Dinner',
        ...
        'hour': 'hrs',
        'min': 'min',
        'steps_vs_last': 'Steps vs Last Week',
        'sleep_vs_last': 'Sleep vs Last Week',
        'hrv_vs_last': 'HRV vs Last Week',
        'rhr_vs_last': 'Resting HR vs Last Week',
    }
}
